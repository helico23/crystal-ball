  ...
  if (lang === "fr") {
    if (!userQuestion) {
      ...
      switch (randomNumber) {
        case 1:
          eightBall =
            "les étoiles s'alignent en ta faveur. La réponse est OUI.";
          break;
        case 2:
          eightBall =
            "les esprits chuchotent un non... Le destin peut encore changer.";
          break;
        case 3:
          eightBall =
            "la brume du futur est trop épaisse aujourd'hui. Reviennez plus tard.";
          break;
        case 4:
          eightBall =
            "mon cristal montre des signes contradictoires... La prudence est de mise.";
          break;
        case 5:
          eightBall = "les anciens Oracles sourient - c'est le moment parfait!";
          break;
        case 6:
          eightBall = "les cartes montrent des obstacles sur votre chemin.";
          break;
        case 7:
          eightBall =
            "l'énergie est neutre. Tout dépend de vos actions maintenant.";
          break;
        case 8:
          eightBall =
            "le grand livre du destin s'ouvre à la page... OUI en lettres de feu!";
          break;
      }
    ...
    if (!userQuestion) {
      ...
      switch (randomNumber) {
        case 1:
          eightBall = "the stars align in your favor. The answer is YES.";
          break;
        case 2:
          eightBall = "the spirits whisper a no... Fate can still change.";
          break;
        case 3:
          eightBall =
            "the mist of the future is too thick today. Come back later.";
          break;
        case 4:
          eightBall =
            "my crystal shows contradictory signs... Caution is advised.";
          break;
        case 5:
          eightBall = "the ancient Oracles smile - this is the perfect moment!";
          break;
        case 6:
          eightBall = "the cards show obstacles on your path.";
          break;
        case 7:
          eightBall =
            "the energy is neutral. Everything depends on your actions now.";
          break;
        case 8:
          eightBall =
            "the great book of destiny opens to the page... YES in letters of fire!";
          break;
      }
